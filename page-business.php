          ...
          <ul class="fs-4 col-7">
            <li>
              <a href="#human-resource"
                ><i class="bi bi-triangle"></i>人事労務に関する相談</a
              >
            </li>
            <li>
              <a href="#insurance"
                ><i class="bi bi-triangle"></i>労働保険・社会保険手続き</a
              >
            </li>
            <li>
            ...
            <li>
              <a href="#labor-regulations"
                ><i class="bi bi-triangle"></i>就業規則作成</a
              >
            </li>
            <li>
        ...
        <div class="row">
          ...
          <div class="col-7 contents fs-4">
            ...
            <ul class="list">
              ...
              <li>
                <i class="bi bi-dot"></i
                >初めて従業員を採用するが、何をしたら良いかわからない…
              </li>
              <li>
                <i class="bi bi-dot"></i
                >最新の法改正に合った労務管理ができているか心配…
              </li>
              <li>
                <i class="bi bi-dot"></i
                >従業員と揉めてしまって、対応に困っている
              </li>
        ...
        <div class="row">
          ...
          <div class="col-7 contents fs-4">
            ...
            <ul class="list">
              ...
              <li>
                <i class="bi bi-dot"></i
                >従業員の入社～退社まで、どんな手続きがあるかわからない
              </li>
              <li>
                <i class="bi bi-dot"></i
                >担当者が退職したため、社内でわかる人がいない
              </li>
              <li>
                <i class="bi bi-dot"></i
                >正しい社会保険の手続きができているか不安
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-7 contents fs-4">
            ...
            <ul class="list">
              <li>
                <i class="bi bi-dot"></i
                >従業員数が１０名以上となったため、就業規則が必要になった
              </li>
              <li>
                <i class="bi bi-dot"></i
                >就業規則はあるが、最新の法改正に対応していない
              </li>
              <li>
                <i class="bi bi-dot"></i
                >テレワークを導入したが、就業規則に規定をしていなかった
              </li>
              <li>
                <i class="bi bi-dot"></i
                >育児休業を取得する従業員がいるが、関係ルールが整備されていない
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-7 fs-4 text-center">
            <div class="pricelist my-5"><a href="price.html">料金表</a></div>
          </div>
