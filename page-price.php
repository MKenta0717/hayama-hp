        ...
        <div class="row">
          ...
          <div class="col-lg-7 contents fs-5">
            <ul>
              ...
              <li>
                〇　各種社会保険・労働保険に関する手続き<br /><span class="fs-6"
                  >　　　※労働保険料の年度更新・算定基礎届の申請等は別途お見積もりいたします。</span
                >
              </li>
            </ul>

            <table
              class="table text-center border-white table-bordered fs-6 mt-4"
            >
              <thead>
                <tr>
      ...
      <div class="container-lg price-parts">
        <div class="row">
          ...
          <div class="col-lg-7 contents fs-5">
            <ul>
              <li>
                〇　月次給与・賞与計算<br /><span class="fs-6"
                  >　　　年次有給休暇の管理、支給控除項目入力、銀行振込データ作成、各種帳票作成など</span
                >
              </li>
              <li>〇　日常の人事・労務管理及び労働法令に関する相談・助言</li>
            </ul>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-7 fs-4 text-center">
            <div class="business my-5">
              <a href="<?php echo home_url('business');?>">業務案内</a>
            </div>
          </div>
        </div>
      </div>
